...
listed are gone: the nitpicky skip notice is retired, and file dependencies now
include every included file. Evidence: the environment oracle at 25 projects / 78
documents and the read-phase doctree oracle at 428 cases, both zero divergence.
